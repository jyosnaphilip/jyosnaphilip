...
- ⚡ Fun fact: ...
-->
Here's what you can find in my GitHub profile!
|Project|Tools/Skills used|Status|
|-------|---------|----------|
|[Banking Management System with Python](https://github.com/jyosnaphilip/Banking-management-system-with-python)| Python, Jupyter Notebook| Completed|
|[My Portfolio](https://github.com/jyosnaphilip/my_portfolio)| HTML, CSS, JavaScript, Bootstrap| Constantly Updated|
